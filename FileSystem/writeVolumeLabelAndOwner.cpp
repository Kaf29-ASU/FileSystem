...
TEST_F(TestVolumeLabelAndOwner, longVolumeLabel)		//длинная метка тома и подходящее имя владельца
{
	stringstream s;
...
TEST_F(TestVolumeLabelAndOwner, correctVolumeLabelAndLongOwner)		//успешное задание метки тома и длинное имя владельца
{
	stringstream s;
	s<<"LocalDriveD"<<endl;
...
TEST_F(TestVolumeLabelAndOwner, LongVolumeLabelAndLongOwner)		//длинная метка тома и имя владельца
{
	stringstream s;
