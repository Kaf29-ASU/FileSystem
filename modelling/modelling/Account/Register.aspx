<%@ Page Title="Регистрация" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="modelling.Account.Register" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="accountInfo">
                        ...
                        <p class="submitButton">
                            <asp:Button ID="CreateUserButton" OnClick="" runat="server" CommandName="MoveNext" Text="Создать пользователя" 
                                 ValidationGroup="RegisterUserValidationGroup"/>
                        </p>
                    </div>
                </ContentTemplate>
